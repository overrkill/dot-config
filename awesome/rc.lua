--[[
	...
	Github : https://github.com/overrkill     
--]]
...
--      {description = "dropdown terminal" , group = "function keys"}),
 -- Dropdown application
    ...
    --Screenshot 
    awful.key({ altkey }, "p", function () awful.util.spawn( "scrot -s" ) end,
    ...
    awful.key({ modkey }, "t", function () awful.util.spawn( "xfce4-terminal --drop-down" ) end,
    ...
    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("scrot 'scrot-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f ~/Pictures/scrots/'") end,
...
-- Bling Tabbed 
awful.key({altkey,"Shift"},"w", function() bling.module.tabbed.pick() end,{description="picks a client with your cursor to add to the tabbing group",group="bling tabs"}),
awful.key({altkey,"Shift"},"q", function() bling.module.tabbed.pop() end,{description="removes the focused client from the tabbing group",group = "bling tabs"}),
awful.key({altkey,"Shift"},"c", function() bling.module.tabbed.iter() end,{ description="iterates through the currently focused tabbing group",group="bling tabs"}),
awful.key({altkey,"Shift"},"a", function() bling.module.tabbed.pick_with_dmenu("rofi") end,{ description="iterates through the currently focused tabbing group",group="bling tabs"}),
